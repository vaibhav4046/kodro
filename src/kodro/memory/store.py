...
single SQLite file under ``~/.kodro/`` so a teacher can back it up
...
:mod:`kodro.memory.pupil_model` can persist the rolling score
...
DEFAULT_DB_PATH: Path = app_dir() / "pupil.db"
