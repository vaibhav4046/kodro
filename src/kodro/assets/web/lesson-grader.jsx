/*
 * Browser lesson grader - the JS twin of kodro/lessons/grader.py plus the
 ...
 * generated from src/kodro/lessons/library/*.yaml. scripts/qa_grader.mjs
...
(function () {
  ...
  var LESSON_DATA = {
    "000_watch_it_go": {"world":{"base":[1,1],"samples":[[3,1]],"obstacles":[],"width":6,"height":6},"criteria":[{"min_distance_travelled":2},{"no_collisions":true}],"hints":{"onFailure":["Press Run once and watch. Then change the 1 in move_forward(1) to 2.","Your finished step should say move_forward(2)."],"onSuccess":[]}},
    ...
    "00a_turn_the_corner": {"world":{"base":[1,1],"samples":[[3,3]],"obstacles":[],"width":6,"height":6},"criteria":[{"calls_in_order":["move_forward","turn_left","move_forward"]},{"min_distance_travelled":4},{"no_collisions":true}],"hints":{"onFailure":["Drive first, then turn, then drive again: move_forward, turn_left, move_forward.","turn_left(90) makes a quarter turn. The rover turns on the spot, it does not move."],"onSuccess":[]}},
    ...
    "00d_fix_the_turn": {"world":{"base":[1,1],"samples":[[2,3]],"obstacles":[{"x":3,"y":1,"r":0.4}],"width":6,"height":6},"criteria":[{"calls_in_order":["move_forward","turn_left","move_forward"]},{"min_distance_travelled":3},{"no_collisions":true}],"hints":{"onFailure":["Watch the run: the rover turns right, towards the wall. Which way should it turn to reach the flag?","Change turn_right(90) to turn_left(90). Everything else is already correct."],"onSuccess":[]}},
    ...
    "04a_fix_the_condition": {"world":{"base":[1,1],"samples":[[1,3]],"obstacles":[{"x":1.8,"y":1,"r":0.4}],"width":6,"height":6},"criteria":[{"uses_construct":"if"},{"min_distance_travelled":2},{"no_collisions":true}],"hints":{"onFailure":["Read the condition out loud: 'if NOT obstacle ahead, turn'. That is the opposite of careful driving.","Remove the word 'not'. The rover should turn WHEN an obstacle is ahead."],"onSuccess":[]}},
