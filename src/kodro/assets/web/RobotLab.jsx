...
(function () {
  ...
  function RobotLab(props) {
    ...
    function applyBattery(id) {
      ...
      setSpec(s => {
        const phys = Object.assign({}, s.physical || {});
        phys.battery = { mAh: b.mAh, voltage: b.voltage, usableFraction: b.usableFraction };
        return Object.assign({}, s, { physical: phys });
      });
        ...
        React.createElement('div', { className: 'modal modal-wide rl-modal', role: 'dialog', 'aria-modal': 'true', 'aria-label': 'Robot Lab', onClick: e => e.stopPropagation() },
          ...
          React.createElement('div', { className: 'rl-body' },
            ...
            React.createElement('div', { className: 'rl-spec' },
              ...
              React.createElement('div', { className: 'rl-stat' }, React.createElement('b', null, (d.phys && d.phys.runtimeMin !== undefined) ? '~' + d.runtimeMin + ' min' : '~' + ((report && report.numbers && report.numbers.rangeM) || d.rangeM) + ' m'), React.createElement('span', null, (d.phys && d.phys.runtimeMin !== undefined) ? 'battery / charge ' : 'driving range / charge (this world) ', Badge('approximated'))),
