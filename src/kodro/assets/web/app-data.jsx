...
say("Survey done")`
  ...
  const BLOCK_DEFS = [
    ...
    { k: 'collect', label: 'collect sample', lessonOnly: true, code: () => 'collect_sample()', color: 'var(--success)' },
    { k: 'drop', label: 'drop sample', lessonOnly: true, code: () => 'drop_sample()', color: 'var(--success)' },
