...
from kodro.engine.sensors import IMUReading, imu_reading, lidar_distance
from kodro.ui import orbital
from kodro.ui.charts import ArcGauge, Compass, LineChart, MiniMap
...
class SensorsPanel(ttk.Frame):
    ...
    def __init__(self, parent: tk.Misc) -> None:
        ...
        self._battery_chart = LineChart(
            self, label="Battery %", colour=orbital.SUCCESS, warn_below=20.0
        )
    ...
    def update_from_rover(self, rover: Rover) -> None:
        ...
        from kodro.engine.sensors import colour_under
