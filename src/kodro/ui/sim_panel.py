...
the headless renderer tests in :mod:`kodro.engine.renderer` stay
green.
"""
...
from kodro.engine import renderer
from kodro.engine.particles import ParticleSystem, system_for_terrain
