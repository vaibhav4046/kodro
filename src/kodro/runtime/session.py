...
* the Tk desktop app (:mod:`kodro.app`),
* the pywebview bridge behind the React shell (:mod:`kodro.web.app`),
* and now the MCP server (:mod:`kodro.mcp.server`).
...
from kodro.lessons.grader import GradeResult, grade
