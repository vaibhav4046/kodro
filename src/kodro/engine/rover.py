...
Pupil-facing functions in :mod:`kodro.rover_api` will, once wired up in
...
motion model (:mod:`kodro.engine.motion_model`), the same table the JS
...
class Rover:
    ...
    :mod:`kodro.rover_api` layer above already clamps everything.
    """
