...
Sensors read the current :class:`~kodro.engine.rover.Rover` and its
bound :class:`~kodro.engine.world.World` and return a quantity in the
...
def imu_reading(rover: Rover) -> IMUReading:
    ...
    velocity. Once :mod:`kodro.engine.physics` is wired into the
