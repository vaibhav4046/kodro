...
are read from :mod:`kodro.engine.terrain` and applied as Pymunk shape
...
#: "matches ~/.kodro/config.toml under [engine] timestep"; that file is
...
class PhysicsSpace:
    ...
    def __init__(
        ...
        *,
        ...
        # :mod:`kodro.engine.rover` instead.
