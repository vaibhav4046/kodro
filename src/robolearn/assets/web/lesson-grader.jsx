...
(function () {
  ...
  var LESSON_DATA = {
    ...
    "00c_look_first": {"world":{"base":[1,1],"samples":[],"obstacles":[{"x":1.8,"y":1,"r":0.4}],"width":6,"height":6},"criteria":[{"uses_construct":"if"},{"no_collisions":true}],"hints":{"onFailure":["Ask the sensor first: 'if obstacle_ahead():' then turn out of the way.","After the if, drive forward. Keep the move_forward OUTSIDE the if so it always runs."],"onSuccess":[]}},
