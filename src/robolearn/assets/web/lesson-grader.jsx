...
(function () {
  ...
  var LESSON_DATA = {
    ...
    "00b_repeat_square": {"world":{"base":[3,3],"samples":[],"obstacles":[],"width":8,"height":8},"criteria":[{"uses_construct":"for"},{"no_collisions":true}],"hints":{"onFailure":["Use a loop: 'for side in range(4):' then indent the steps to repeat.","Inside the loop, move_forward and then turn_right(90) to make each corner."],"onSuccess":[]}},
    ...
    "10_optimisation": {"world":{"base":[1,1],"height":8,"obstacles":[],"samples":[[2,6],[5,5],[7,2]],"width":10},"criteria":[{"samples_collected":3},{"returns_to_base":true},{"max_battery_used":70}],"hints":{"onFailure":["If the rover overshoots, lower the per-step distance from 0.5 m to 0.2 m.","Compare the total distance for at least two different sample orderings."],"onSuccess":[]}},
