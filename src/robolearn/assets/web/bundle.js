...
(function () {
  ...
  function TerrainGround({
    ...
    }), isEarth ? /*#__PURE__*/React.createElement(EarthFeatures, null) : null, showGrid !== false ? /*#__PURE__*/React.createElement("div", {
...
(function () {
  ...
  function RobotLab(props) {
    ...
    }, React.createElement('b', null, d.commands.length ? d.commands.map(c => c + '()').join('  ') : 'move()  turn()  only'), React.createElement('span', null, 'commands this build supports')))), React.createElement('div', {
      className: 'rl-foot'
