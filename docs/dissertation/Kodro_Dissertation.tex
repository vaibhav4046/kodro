...
\item \textbf{Rigid-body physics on the hot path}, making the tested physics wrapper the source of truth for the visible motion, so the viewport reflects real contact forces, friction and collision response.
