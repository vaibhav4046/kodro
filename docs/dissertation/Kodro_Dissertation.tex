...
\caption{The default Simple proving surface. The mission cockpit exposes only the robot, world, test, deterministic readiness check and primary Run action beside the three dimensional City. Program editing and the evidence history are deliberate transitions rather than permanent panels.}
\label{fig:city}
\end{figure}
...
\midrule
Low & 18.1 & 89.1 ms & 65.0 ms & Not met \\
High & 17.6 & 84.8 ms & 60.3 ms & Not met \\
\bottomrule
\end{tabular}
