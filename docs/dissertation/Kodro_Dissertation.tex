...
Feedback on my earlier proposal document was that its prose read as machine-generated, that it lacked a BCS section and that ethics was not treated separately. I took all three seriously. This dissertation was rewritten by hand in my own voice; the generative tools I used are declared on the Declaration page and their outputs were treated as proposals to be checked, never as evidence; and ethics and professional issues have this chapter to themselves. If I were advising a student starting this project, I would say that the honesty machinery, the fidelity badges, the provenance record and the gates, is not overhead to add at the end. It is the part of the product a skeptical reader can verify, and it is the part I am proudest of.
