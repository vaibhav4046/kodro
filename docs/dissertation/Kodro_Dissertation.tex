...
\item \textbf{The human studies} specified in the evaluation, the usability study, the help study and the refinement-ablation study, run under consent with the instrumentation that is already in place.
\end{enumerate}
