...
This is a favourable convenience sample of people known to the author, and it is reported as anonymous volunteer feedback on the released product, not as a usability study. It does not replace the planned human evaluation above and no general claim is drawn from it. At the time of writing four volunteers had responded, three with a computing or engineering background and one from another field. Every answer sits in the top two boxes of its scale and no respondent chose a bottom-two box anywhere: two found the purpose clear straight away and two after a little looking; three ran a program easily and one after some figuring out; one said the lesson feedback told them exactly what to fix and three that it pointed them in the right direction; three would definitely recommend the product to a beginner or a teacher and one probably would. Of the two free-text answers, one asked for more course content and requested no fixes, and the other answered a different question than the one asked and is counted as a non-response, a small instrument lesson recorded for any future questionnaire.
\fi
