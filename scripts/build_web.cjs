...
const ORDER = ['motion-model.js', 'specschema.js', 'parts-db.js', 'project.js', 'runreport.js', 'pupil-store.js', 'gpu-caps.js', 'icons', 'agents', 'memory', 'memory-graph.js', 'terrains', 'Rover', 'Viewport', 'textures', 'post', 'worldfx', 'ambient', 'Viewport3D', 'Editor', 'Telemetry', 'tweaks-panel', 'diagnostics', 'selftest', 'RobotLab', 'scenario', 'lesson-grader', 'lesson-studio.js', 'verify', 'realism', 'demo', 'onboarding', 'home', 'ai-providers', 'ai-web', 'chat-intent.js', 'sim-physics.js', 'hooks', 'app-data', 'panels', 'app'];
