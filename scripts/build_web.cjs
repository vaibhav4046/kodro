...
const ORDER = ['agents', 'memory', 'terrains', 'Rover', 'Viewport', 'textures', 'post', 'Viewport3D', 'Editor', 'Telemetry', 'tweaks-panel', 'diagnostics', 'selftest', 'RobotLab', 'scenario', 'realism', 'demo', 'onboarding', 'ai-web', 'app'];
