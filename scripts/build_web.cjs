...
const ORDER = ['motion-model.js', 'specschema.js', 'project.js', 'runreport.js', 'icons', 'agents', 'memory', 'terrains', 'Rover', 'Viewport', 'textures', 'post', 'worldfx', 'ambient', 'Viewport3D', 'Editor', 'Telemetry', 'tweaks-panel', 'diagnostics', 'selftest', 'RobotLab', 'scenario', 'verify', 'realism', 'demo', 'onboarding', 'ai-web', 'hooks', 'app-data', 'panels', 'app'];
