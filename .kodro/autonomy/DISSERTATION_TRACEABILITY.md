# Dissertation traceability - CA1 feedback, BCS criteria and evidence
...
| Evaluation must not overclaim; simulated study is not human data | Evaluation chapter frames the persona panel strictly as automated scenario-based evaluation; Professional Issues declines to report validation that has not happened; the 10-15 participant pilot is future work under ethics | evaluation chapter + \chapter{Professional Issues} | RESOLVED |
...
- Automated personas are described ONLY as automated scenario-based evaluation,
  ...
  ethics approval. The planned 10-15 participant pilot is a stated limitation / future
  evaluation.
...
## C. BCS computing abilities -> evidence map

| BCS ability | Evidence (code + tests + this repo) |
|-------------|-------------------------------------|
...
The canonical dissertation adds a finer mapping from BCS abilities 2.1.1 to
2.1.9 to specific project evidence in Table 8.1. The source is the official BCS
January 2020 course-accreditation guideline, not a locally invented rubric.
...
- Build: 50 pages and approximately 20,005 body words; 26/26 citations and
  bibliography entries; clean multi-pass `pdflatex`; zero Unicode en/em dashes.
- Screenshots/figures: real, from the working build.
- All 50 pages rendered and visually inspected on 13 August 2026.
